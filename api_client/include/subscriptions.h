...
class Subscriptions {
    public:
        ...
        bool createMonitoredItems(UA_TimestampsToReturn timestamp) {
            ...
            for (auto& request : requests) {
                auto response = std::unique_ptr<UA_MonitoredItemCreateResult, decltype(&Subscriptions::deleteResponses)>(new UA_MonitoredItemCreateResult, &Subscriptions::deleteResponses);
    ...
    private:
        ...
        std::vector<std::unique_ptr<UA_MonitoredItemCreateRequest, decltype(&deleteRequests)>> requests; 
        std::vector<std::unique_ptr<UA_MonitoredItemCreateResult, decltype(&deleteResponses)>> responses;
};
